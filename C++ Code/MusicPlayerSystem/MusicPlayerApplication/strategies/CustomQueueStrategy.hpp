...
#include <queue> // FIX: Added missing header
#include <stack> // FIX: Added missing header
...
public:
    ...
    // FIXED: Corrected logic to check stack and sequential history
    bool hasPrevious() override {
        return !prevStack.empty() || (currentIndex > 0);
    }
